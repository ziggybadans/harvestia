...
public class ModBlocks {
    ...
    public static final Block FAILING_WHEAT_CROP = Registry.register(Registries.BLOCK, new Identifier(Harvestia.MOD_ID, "failing_wheat_crop"),
            new FailingCropBlock(FabricBlockSettings.copy(Blocks.WHEAT)));
